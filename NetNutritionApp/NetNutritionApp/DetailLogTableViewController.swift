//
//  DetailLogTableViewController.swift
//  NetNutritionApp
//
...
class nutritionHistoryCell: UITableViewCell {
    
    @IBOutlet weak var nutrient: UILabel!
    @IBOutlet weak var info: UILabel!
}

class DetailLogTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "nutritionHistoryCell", for: indexPath) as! nutritionHistoryCell

        print("NUTRITION INFO BELOW")
        print(nutrition)
